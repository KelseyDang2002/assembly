...
gcc -c -m64 -Wall -fno-pie -no-pie -o main.o main.c -std=c17 -g

echo "bash: Assembling assembly.asm..."
nasm -f elf64 -l assembly.lis -o assembly.o assembly.asm -gdwarf

echo "bash: Linking the two created object files..."
gcc -m64 -fno-pie -no-pie -o a.out main.o assembly.o -std=c17 -g
