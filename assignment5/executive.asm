...
desc_msg db "executive: This program will generate 64-bit IEEE float numbers.", 10, 0
prompt_numbers db "executive: How many numbers do you want? Today's limit is 100 per customer: ", 0
array_msg db "executive: Your numbers have been stored in an array. Here is that array.", 10, 0

normalize_msg_1 db "executive: The array will now be normalized to the range 1.0 to 2.0.", 10, 0
normalize_msg_2 db "executive: Here is the noramlized array.", 10, 0

goodbye_msg db "executive: Good-bye %s. You are welcome any time.", 10, 0
